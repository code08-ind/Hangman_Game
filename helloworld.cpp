...
{
    Hangman hg;
    hg.setCorrectString("HANGMAN");
    hg.setGuessedString(hg.getCorrectString());
    ...
    sf::Text text4(hg.getGuessedString(), font);
    ...
    rectangle[0].setOutlineColor(sf::Color::Cyan);
    ...
    rectangle[1].setOutlineColor(sf::Color::Cyan);
    ...
    rectangle[2].setOutlineColor(sf::Color::Cyan);
    ...
    rectangle[3].setRotation(30);
    rectangle[3].setOutlineColor(sf::Color::Cyan);
    ...
    rectangle[4].setRotation(330);
    rectangle[4].setOutlineColor(sf::Color::Cyan);
    ...
    rectangle[5].setOutlineColor(sf::Color::Cyan);
    ...
    rectangle[6].setOutlineColor(sf::Color::Cyan);
    ...
    rectangle[7].setOutlineColor(sf::Color::Cyan);
                        ...
                        if (isalnum(static_cast<char>(event.text.unicode)))
                        {
                            ...
                            else
                            {
                                ...
                                if (hg.guessWord(toupper(static_cast<char>(event.text.unicode))))
                                {
                                    ...
                                    if (hg.getCorrectString() == hg.getGuessedString())
                                    {
                                        text5.setString("You Won!!!!");
                                        text4.setCharacterSize(50);
                                        text4.setString("You guessed \"Hangman\"");
                                        soundintro.play();
                                    }
                                }
                                else
                                {
                                    ...
                                    if (hg.isLost())
                                    {
                                        ...
                                        text4.setCharacterSize(50);
                                        text4.setString("You didnt guess \"Hangman\"");
                                    }
                                }
                            }
                        }
